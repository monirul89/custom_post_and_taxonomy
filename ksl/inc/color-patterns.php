 ...
 */
function ksl_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter ksl default saturation level.
	 *
	 * @since ksl 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'ksl_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.ksl-front-page) .entry-title,
...
.colors-custom .ksl-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.ksl-front-page .panel-content .recent-posts article,
...
.colors-custom.ksl-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'ksl_custom_colors_css', $css, $hue, $saturation );
}
